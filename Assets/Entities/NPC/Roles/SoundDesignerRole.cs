	...
	public override List<string> Role { get; set; } = new List<string>
{
	...
	"I’m going to record myself biting a plastic bottle and I’ll use it for the eating apples sound FX.",
	...
	"I think I’ve got the perfect microphone for recording this.",
	"I recorded a few samples from popcorn. I’m sure I'll find some place in the game to implement it.",
	...
	"I just recorded a balloon, and I’ll use it for when the model is getting stretched."
};
