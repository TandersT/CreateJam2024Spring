...
public class ProgrammerRole : SharedRole
{
	public override List<string> Novice { get; set; } = new List<string>
	{
		...
		"Learning to code alone is challenging. Should I get into an education in Computer Science?",
		"My cousin told me if I had an education in programming I would understand coding a lot better than I do now… I wonder…",
		"So, apparently I can use a dot to access the properties of an object. Did I get that one right?",
		...
		"I’m dividing 3 by 2 and it’s giving me 1, but it’s definitely 1.5! What did you say? Floats? I don’t know what you are saying…",
	...
	public override List<string> Intermediate { get; set; } = new List<string>
{
	...
	"My coding is getting better with every bug I encounter.",
	...
	public override List<string> Expert { get; set; } = new List<string>
{
	...
	"Coding an algorithm is child’s play.",
	...
	"I’ve debugged more lines of code in my life than there are grains of sand in the Sahara Desert.",
	"My coding skills are so good that it’ll impress advanced alien civilizations.",
	"My coding is ART. Full stop.",
	...
	public override List<string> Role { get; set; } = new List<string>
	{
		...
		"They’ve chosen me to code the game.",
		...
		"I’m implementing a dictionary to save the Player’s coordinates when moving across scenes.",
		"Creating a variable… And another one… And another one… And another one…",
